...
namespace DSAA.Repository
{
    ...
    public abstract class RepositoryBase<TEntity, TPrimaryKey> : IRepository<TEntity, TPrimaryKey> where TEntity : Entity<TPrimaryKey>
    {
        ...
        public RepositoryBase(EntityDbContext dbContext)
        {
        ...
        /// </summary>
        /// <param name="entity">实体</param>
        public string InsertOrUpdate(TEntity entity)
        {
            if (_dbContext.Set<TEntity>().Any(x => x.Id.Equals(entity.Id)))
            {
                Update(entity);
                return "更新";
            }
    ...
    /// </summary>
    /// <typeparam name="TEntity">实体类型</typeparam>
    public abstract class RepositoryBase<TEntity> : RepositoryBase<TEntity, Int32> where TEntity : Entity
    {
        public RepositoryBase(EntityDbContext dbContext) : base(dbContext)
        {
        }
    }
}
